import { Node } from '../../src/helper/drawTree';
...
describe('Node', () => {
    ...
    it('Gives the correct left sibling.', () => {
        ...
        const sib = node.children[1].leftSibling();
    ...
    it('Gives the correct leftmost sibling', () => {
        const node = new Node(tree);
        const sib1 = node.children[1].lMostSibling();
        const sib2 = node.children[2].lMostSibling();
